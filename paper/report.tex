...
\input{../output/tables/appendix3_panelA_waemu_gdp_growth_factor.tex}

\input{../output/tables/appendix3_panelB_caemc_gdp_growth_factor.tex}

\input{../output/tables/appendix4_non_cfa_gdp_growth_factor.tex}
