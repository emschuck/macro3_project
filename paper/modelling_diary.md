...
* 20-05-2026 [MM]: First synthetic control run with Gabon, Ivory Coast and the Republic of Congo gives us the first results, but the weights do not match the ones in the paper. 
